...
<!--      <aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand bg-wood-dark">-->
      <aside class="main-sidebar sidebar-light-primary elevation-4 sidebar-no-expand bg-gradient-cyan">
        <!-- Brand Logo -->
<!--        <a href="--><?php //echo base_url ?><!--admin" class="brand-link bg-primary bg-gradient text-sm">-->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-gradient-cyan text-sm">
